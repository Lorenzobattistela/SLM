...
PLOT_SPECS: dict[str, PlotSpec] = {
    ...
    "perplexity": PlotSpec(
        name="perplexity",
        keys=("validation_perplexity", "perplexity"),
        filename="perplexity.png",
        title="Validation Perplexity",
        ylabel="Perplexity",
    ),
    "train_perplexity": PlotSpec(
        name="train_perplexity",
        keys=("train_perplexity",),
        filename="train_perplexity.png",
    ...
    "tokens_per_second": PlotSpec(
        name="tokens_per_second",
        keys=("tokens_per_second", "log_window_tokens_per_second"),
        filename="tokens_per_second.png",
        title="Training Throughput",
        ylabel="Tokens/second",
        optional=True,
    ),
    "samples_per_second": PlotSpec(
        name="samples_per_second",
        keys=("samples_per_second",),
        filename="samples_per_second.png",
        title="Sample Throughput",
        ylabel="Samples/second",
        optional=True,
    ),
    "step_time_seconds": PlotSpec(
        name="step_time_seconds",
        keys=("step_time_seconds",),
        filename="step_time_seconds.png",
        title="Step Time",
        ylabel="Seconds",
        optional=True,
    ),
    "token_progress": PlotSpec(
        name="token_progress",
        keys=("token_progress_percent",),
        filename="token_progress.png",
        title="Token Budget Progress",
        ylabel="Progress (%)",
        optional=True,
    ),
    "epoch_equivalent": PlotSpec(
        name="epoch_equivalent",
        keys=("epoch_equivalent",),
        filename="epoch_equivalent.png",
        title="Training Epoch Equivalent",
        ylabel="Epochs",
        optional=True,
    ),
    "gpu_memory_allocated": PlotSpec(
        name="gpu_memory_allocated",
        keys=("gpu_memory_allocated_gb",),
        filename="gpu_memory_allocated.png",
        title="GPU Memory Allocated",
        ylabel="GiB",
        optional=True,
    ),
    "gpu_memory_reserved": PlotSpec(
        name="gpu_memory_reserved",
        keys=("gpu_memory_reserved_gb",),
        filename="gpu_memory_reserved.png",
        title="GPU Memory Reserved",
        ylabel="GiB",
        optional=True,
    ),
    "gpu_memory_max_allocated": PlotSpec(
        name="gpu_memory_max_allocated",
        keys=("gpu_memory_max_allocated_gb",),
        filename="gpu_memory_max_allocated.png",
        title="GPU Max Memory Allocated",
        ylabel="GiB",
        optional=True,
    ),
}
