...
#   cd /home/ap208/SLM
#   sbatch run_tokenizer.sh
#
# Local/manual:
#   bash run_tokenizer.sh
#
# Optional overrides:
#   RUN_CONFIG=configs/train_200m_fineweb_edu.yml sbatch run_tokenizer.sh
#   OUTPUT_DIR=/home/ap208/slm-utils/data/processed_byte_bpe_gpt2 sbatch run_tokenizer.sh
#   SOURCE_PROCESSED_DIR=/home/ap208/slm-utils/data/processed sbatch run_tokenizer.sh
#   BYTE_BPE_NAME=gpt2 sbatch run_tokenizer.sh
#   RETOKENIZE_OVERWRITE=1 sbatch run_tokenizer.sh
#   MAX_DOCUMENTS=100 sbatch run_tokenizer.sh
#   PYTHON_BIN=.venv/bin/python sbatch run_tokenizer.sh
