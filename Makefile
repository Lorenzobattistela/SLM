...
.PHONY: install install-app prepare-tokenizer tokenize count train-ddp evaluate sample sample-ui chatbot plot run-all debug-tokenizer debug-tokenize debug-count test
