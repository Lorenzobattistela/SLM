...
#
# Optional overrides:
#   TOKENIZER_CONFIG=pre-train/tokenizer/superbpe_50k_olmo_p99.yml sbatch pre-train/tokenizer/run_tokenizer.sh
#   TOKENIZER_CORPUS_WORKERS=4 sbatch pre-train/tokenizer/run_tokenizer.sh
#   TOKENIZER_TRAIN_SAMPLES=500000 sbatch pre-train/tokenizer/run_tokenizer.sh
#   TOKENIZER_MEMORY_LIMIT_GB=32 sbatch pre-train/tokenizer/run_tokenizer.sh
#   TOKENIZER_FORCE=1 sbatch pre-train/tokenizer/run_tokenizer.sh
#   RAYON_NUM_THREADS=4 sbatch pre-train/tokenizer/run_tokenizer.sh
...
TOKENIZER_CONFIG="${TOKENIZER_CONFIG:-pre-train/tokenizer/superbpe_50k_olmo_p99.yml}"
...
TRAIN_CMD=(
  "$PYTHON_BIN"
  pre-train/tokenizer/train_superbpe_50k.py
