...
def _existing_tokenization_state(
    *,
    ...
    resumable = (
        ...
        and (train_tokens < target_train_tokens or validation_tokens < target_validation_tokens)
    )
    return {
        "metadata": metadata,
...
def _tokenize_shard(
    ...
    with (
        ...
        for shard_sample_index, text in enumerate(shard_texts):
            ...
            send_to_validation = not val_writer.complete and is_validation_text(
                stripped, validation_ratio, validation_salt
            )
    ...
    *,
    ...
    with (
        ...
        return {
            ...
            "samples_tokenized": sum(stats["samples_tokenized"] for stats in shard_stats.values()),
