...
output directory: artifacts/tokenizer_superbpe_50k_olmo_p99/
config: tokenizer/superbpe_50k_olmo_p99.yml
```
...
```bash
TOKENIZER_CORPUS_WORKERS=4 bash tokenizer/run_tokenizer.sh
TOKENIZER_TRAIN_SAMPLES=500000 bash tokenizer/run_tokenizer.sh
TOKENIZER_MEMORY_LIMIT_GB=32 bash tokenizer/run_tokenizer.sh
TOKENIZER_FORCE=1 bash tokenizer/run_tokenizer.sh
RAYON_NUM_THREADS=4 bash tokenizer/run_tokenizer.sh
```
...
artifacts/tokenizer_superbpe_50k_olmo_p99/vocab.json
artifacts/tokenizer_superbpe_50k_olmo_p99/merges.txt
